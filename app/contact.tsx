  ...
  return (
    <section id="contact" className="py-24 px-4 bg-[#0a192f] flex flex-col items-center justify-center">
      <div className="max-w-2xl w-full mx-auto text-center animate-fadeInUp">
        ...
        <button type="button" onClick={() => setIsDrawerOpen(true)} className="inline-block bg-[#64ffda] text-[#0a192f] px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-[#52e3c2] transition-all duration-300 scale-100 hover:scale-105 mb-8 animate-fadeInUp">Say Hello</button>
      ...
      {isDrawerOpen && (
        <div className="contact-drawer-backdrop" role="presentation" onClick={() => setIsDrawerOpen(false)}>
          <div className="contact-drawer" role="dialog" aria-modal="true" aria-labelledby="contact-drawer-title" onClick={(event) => event.stopPropagation()}>
